...
jQuery(function ($) {
    ...
    if(cookieNotice) {
        ...
        gdprCookieNoticeLocales.it = {
            ...
            cookie_analytics_desc: "Usiamo i cookie per migliorare l'esperienza di utilizzo del sito. Scopri di più su come li usiamo in Info. Autorizzi l'uso dei cookie procedendo al sito",
    ...
    $('#msform').submit(function (event) {
        ...
        if(check){
            ...
            $.ajax({
                ...
                url : "http://localhost:3000/registration/checkReg",
                type: "POST",
                ...
                success    : function(data,status,xrh){
                    ...
                    $.ajax({
                        ...
                        url : "http://localhost:3000/registration/create",
                        type: "POST",
                        contentType: "application/json; carset=utf-8",
                        dataType   : "json",
                        data: JSON.stringify(
