$(document).ready(function(){
	...
	$.get("http://highnlow.it/formazione/home", function(data, status){
			...
			text = text +
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-4 card p-3 text-center item">
                    ...
                    <div class="card-caption col-12 p-0">
                        <div class="card-body">
                            <a href="http://highnlow.it/assets/pages/articoli/singolo_formazione.html?id=${_formazione._id}">
    ...
    $.get("http://highnlow.it/idea/home", function(data, status){
		...
		for(var i=0;i<3;i++){
			...
			text = text +
				...
				<div class="col-12 col-md-6 col-lg-4 col-xl-4 card p-3 text-center item">
                    ...
                    <div class="card-caption col-12 p-0">
                        <div class="card-body">
                            <a href="http://highnlow.it/assets/pages/articoli/singolo_idea.html?id=${idea._id}">
                                <h4>${idea.title}</h4>
                            </a>
                        </div>
                        <div class="row card-footer align-items-center justify-content-left xs-justify-content-left sm-justify-content-left">
